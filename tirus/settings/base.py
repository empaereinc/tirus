# flake8: noqa
"""
Django settings for tirus project.
...
WSGI_APPLICATION = 'tirus.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///tirus'),
}
